...
(function ($) {
    ...
    var brandSliderCustom = $('.branding-sliderCustom');
    brandSliderCustom.slick({
        autoplay:true,
        autoplaySpeed:2500,
        slidesToShow: 1,
        slidesToScroll: 0,
    ...
    function setSlideVisibility() {
      ...
      //$('.branding-sliderCustom').on('afterChange', function() { 
        //setSlideVisibility();
      //});
        ...
        $.ajax({
            ...
            .fail(function (data) {
                ...
                if (data.responseText !== '') {
                    ...
                    $(superFormMessages).text('Uups! Ocurrio un error y tu mensaje no pudo ser enviadocould not be sent.');
                }
                ...
                // Set the message text.
                $(superFormMessages).text('Su mensaje fue enviado, pronto recibira una respuesta');
    ...
    function mapInit() {
        ...
        var contentString = '<div id="map-content">' +
            '<div id="bodyContent">' +
            '<p class="text-center"> <span class="map-info-icon"><i class="fa fa-map-o"></i></span> <span class="map-info-content">Microsoft Corporation <br>1 Microsoft Way, Reno,  ' +
            ' NV 89501, USA </span></p> ' +
            '<p class="text-center"> <span class="map-info-icon"><i class="fa fa-phone"></i></span> <span> +880044 545 989 626</span> </p> ' +
            '</div>' +
            '</div>';
